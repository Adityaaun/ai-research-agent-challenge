...
class TestExtractClaims:
    ...
    @patch("backend.app.research.claims.gemini.generate_with_gemini")
    def test_extract_claims_gemini_exception(self, mock_gemini):
...
class TestVerifyClaim:
    ...
    @patch("backend.app.research.claims.gemini.generate_with_gemini")
    def test_verify_claim_support(self, mock_gemini):
    ...
    @patch("backend.app.research.claims.gemini.generate_with_gemini")
    def test_verify_claim_contradict(self, mock_gemini):
    ...
    @patch("backend.app.research.claims.gemini.generate_with_gemini")
    def test_verify_claim_neutral(self, mock_gemini):
    ...
    @patch("backend.app.research.claims.gemini.generate_with_gemini")
    def test_verify_claim_gemini_failure(self, mock_gemini):
